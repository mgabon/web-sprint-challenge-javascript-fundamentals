...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const animals = array.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const population = array.filter(function(item){
...
CuboidMaker.prototype.cuboid = function(cuboidadd){
  let add = this.length + this.height + this.width + cuboidadd;
  return add
}
